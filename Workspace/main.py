...
# Combine real and generated for training only
# all_train_images = real_images + image_paths3
# all_train_labels = real_labels + labels3

# Prepare dataset using only real images for the split
...
# # Now, create a dataset object for the generated data
# generated_dataset = ImageGraphDataset(image_paths3, labels3, segmenter="slic")

# # Combine real and generated for training
# train_ds = torch.utils.data.ConcatDataset([train_real, generated_dataset])
